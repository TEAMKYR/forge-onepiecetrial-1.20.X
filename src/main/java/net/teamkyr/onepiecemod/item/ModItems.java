...
public class ModItems {
    ...
    public static final RegistryObject<Item> VIVRE_CARD = ITEMS.register("vivre_card",
            ()-> new VIVRE_CARDITEM(new Item.Properties().stacksTo(1).rarity(Rarity.EPIC)));

    //Effect Fruits
    public static final RegistryObject<Item> FIRERESIST_FRUIT = ITEMS.register("fireresist_fruit",
            ()-> new Devil_Fruit(new Item.Properties().rarity(Rarity.create("Legendary", ChatFormatting.GOLD)).stacksTo(1)
